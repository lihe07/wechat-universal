...
MOUNTS=(
  #/etc/os-release=/usr/lib/wechat-universal/etc/os-release
  /etc/lsb-release=/usr/lib/wechat-universal/etc/lsb-release
  /usr/lib/license=/usr/lib/wechat-universal/usr/lib/license
